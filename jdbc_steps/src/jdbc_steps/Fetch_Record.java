...
public class Fetch_Record {
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		Connection connection = DriverManager
				.getConnection("jdbc:mysql://localhost:3306/jdbc_steps?user=root && password=SaiVarshith@03");
...
//		double esal =rSet.getDouble(3);
//		System.out.println("Eid = "+eid+"\t Ename = "+name+"\t Esal = "+esal);
//		System.out.println("Eid = "+eid+"\t Ename = "+name+"\t Esal = "+esal);
//		rSet.next();
//		
//		
...
//		  
		...
		ResultSet rSet2 = statement.executeQuery("select * from emp where esal>100000");
		while(rSet2.next()) {
